...
class CommandAction12(BaseModel):
    command: str
    path: str | None = None
    type: Type128 = Field(..., title='ListFilesCommandActionType')
...
class CommandAction13(BaseModel):
    ...
    path: str | None = None
    query: str | None = None
    type: Type129 = Field(..., title='SearchCommandActionType')
...
class CommandAction14(BaseModel):
    command: str
    type: Type130 = Field(..., title='UnknownCommandActionType')
...
class DynamicToolCallOutputContentItem(BaseModel):
    text: str
    type: Type131 = Field(..., title='InputTextDynamicToolCallOutputContentItemType')
...
class DynamicToolCallOutputContentItem8(BaseModel):
    imageUrl: str
    type: Type132 = Field(..., title='InputImageDynamicToolCallOutputContentItemType')
...
class PatchChangeKind4(BaseModel):
    type: Type133 = Field(..., title='AddPatchChangeKindType')
...
class PatchChangeKind5(BaseModel):
    type: Type134 = Field(..., title='DeletePatchChangeKindType')
...
class PatchChangeKind6(BaseModel):
    ...
    type: Type135 = Field(..., title='UpdatePatchChangeKindType')
...
class ThreadItem18(BaseModel):
    ...
    id: str
    type: Type137 = Field(..., title='HookPromptThreadItemType')
...
class ThreadItem20(BaseModel):
    id: str
    text: str
    type: Type139 = Field(..., title='PlanThreadItemType')
...
class ThreadItem21(BaseModel):
    ...
    type: Type140 = Field(..., title='ReasoningThreadItemType')
...
class ThreadItem22(BaseModel):
    ...
    type: Type141 = Field(..., title='CommandExecutionThreadItemType')
...
class ThreadItem24(BaseModel):
    ...
    tool: str
    type: Type143 = Field(..., title='McpToolCallThreadItemType')
...
class ThreadItem25(BaseModel):
    ...
    tool: str
    type: Type144 = Field(..., title='DynamicToolCallThreadItemType')
...
class ThreadItem28(BaseModel):
    id: str
    path: AbsolutePathBuf
    type: Type147 = Field(..., title='ImageViewThreadItemType')
...
class ThreadItem29(BaseModel):
    ...
    status: str
    type: Type148 = Field(..., title='ImageGenerationThreadItemType')
...
class ThreadItem30(BaseModel):
    id: str
    review: str
    type: Type149 = Field(..., title='EnteredReviewModeThreadItemType')
...
class ThreadItem31(BaseModel):
    id: str
    review: str
    type: Type150 = Field(..., title='ExitedReviewModeThreadItemType')
...
class ThreadItem32(BaseModel):
    id: str
    type: Type151 = Field(..., title='ContextCompactionThreadItemType')
...
class UserInput11(BaseModel):
    ...
    type: Type152 = Field(..., title='TextUserInputType')
...
class UserInput12(BaseModel):
    type: Type153 = Field(..., title='ImageUserInputType')
    url: str
...
class UserInput13(BaseModel):
    path: str
    type: Type154 = Field(..., title='LocalImageUserInputType')
...
class UserInput14(BaseModel):
    name: str
    path: str
    type: Type155 = Field(..., title='SkillUserInputType')
...
class UserInput15(BaseModel):
    name: str
    path: str
    type: Type156 = Field(..., title='MentionUserInputType')
...
class WebSearchAction5(BaseModel):
    ...
    query: str | None = None
    type: Type157 = Field(..., title='SearchWebSearchActionType')
...
class WebSearchAction6(BaseModel):
    type: Type158 = Field(..., title='OpenPageWebSearchActionType')
    url: str | None = None
...
class WebSearchAction7(BaseModel):
    ...
    type: Type159 = Field(..., title='FindInPageWebSearchActionType')
    url: str | None = None
...
class WebSearchAction8(BaseModel):
    type: Type160 = Field(..., title='OtherWebSearchActionType')
...
class ThreadItem17(BaseModel):
    ...
    id: str
    type: Type136 = Field(..., title='UserMessageThreadItemType')
...
class ThreadItem19(BaseModel):
    ...
    text: str
    type: Type138 = Field(..., title='AgentMessageThreadItemType')
...
class ThreadItem23(BaseModel):
    ...
    type: Type142 = Field(..., title='FileChangeThreadItemType')
...
class ThreadItem26(BaseModel):
    ...
    type: Type145 = Field(..., title='CollabAgentToolCallThreadItemType')
...
class ThreadItem27(BaseModel):
    ...
    id: str
    query: str
    type: Type146 = Field(..., title='WebSearchThreadItemType')
