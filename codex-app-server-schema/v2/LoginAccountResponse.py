...
class LoginAccountResponse2(BaseModel):
    ...
    loginId: str
    type: Type166 = Field(..., title='Chatgptv2::LoginAccountResponseType')
...
class LoginAccountResponse3(BaseModel):
    loginId: str
    type: Type167 = Field(..., title='ChatgptDeviceCodev2::LoginAccountResponseType')
    userCode: str = Field(
...
class LoginAccountResponse4(BaseModel):
    type: Type168 = Field(..., title='ChatgptAuthTokensv2::LoginAccountResponseType')
