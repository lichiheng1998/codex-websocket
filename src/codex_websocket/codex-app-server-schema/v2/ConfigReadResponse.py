...
class ConfigLayerSource2(BaseModel):
    ...
    type: Type62 = Field(..., title='SystemConfigLayerSourceType')
...
class ConfigLayerSource3(BaseModel):
    ...
    type: Type63 = Field(..., title='UserConfigLayerSourceType')
...
class ConfigLayerSource4(BaseModel):
    ...
    type: Type64 = Field(..., title='ProjectConfigLayerSourceType')
...
class ConfigLayerSource5(BaseModel):
    type: Type65 = Field(..., title='SessionFlagsConfigLayerSourceType')
