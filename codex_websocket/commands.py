...
def _build_parser() -> argparse.ArgumentParser:
    ...
    sub.add_parser("status", add_help=True, help="show bridge status")
...
def _cmd_help() -> str:
    return (
        ...
        "  `/codex status` — show bridge connection and session status\n"
...
def _cmd_status(bridge: CodexBridge) -> str:
